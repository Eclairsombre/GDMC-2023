...
def findGround(xzStart, xz):  # TODO: Change error.
    ...
    """
    im = Image.open("data/heightmap.png")
...
def irlToMc(coordinates):
    ...
    coordinates_final.append(heightmap.getpixel((coordinates[0], coordinates[2]))[0])
        ...
        if base != None:
            ...
            if (
                ...
                if (
                    ...
                    xyz1 = (min(pos1[0], pos2[0]), min(pos1[1], pos2[1]), min(pos1[2], pos2[2]))
                    xyz2 = (max(pos1[0], pos2[0]), max(pos1[1], pos2[1]), max(pos1[2], pos2[2]))
